    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers(HttpMethod.GET,"api/course/enrolled").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.GET,"api/courseReview/{id}/ratings").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.POST,"api/course/{id}/enroll").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.GET,"api/{id}/progress").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.POST,"api/{courseId}/{sectionId}/complete").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.POST,"api/courses/{courseId}/sections/{sectionId}/progress").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.POST,"api/{courseId}/{sectionId}/video").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.POST,"api/courseReview/{id}/rating").hasRole("STUDENT")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/courses/{courseId}/sections/{sectionId}").hasAnyRole("STUDENT", "INSTRUCTOR")
