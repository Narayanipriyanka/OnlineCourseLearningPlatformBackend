    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers(HttpMethod.GET,"api/courseReview/{id}/progress").hasRole("STUDENT")
                        ...
                        .requestMatchers("/api/courses/{courseId}/sections/{sectionId}").hasAnyRole("STUDENT", "INSTRUCTOR")
